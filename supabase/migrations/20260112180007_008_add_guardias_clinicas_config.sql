...
DROP TRIGGER IF EXISTS trigger_update_clinical_groups_updated_at ON clinical_groups_config; CREATE TRIGGER trigger_update_clinical_groups_updated_at BEFORE UPDATE ON clinical_groups_config
  FOR EACH ROW
...
-- Trigger para actualizar updated_at
DROP TRIGGER IF EXISTS trigger_update_clinical_values_updated_at ON clinical_values_config; CREATE TRIGGER trigger_update_clinical_values_updated_at BEFORE UPDATE ON clinical_values_config
  FOR EACH ROW
