...
DROP TRIGGER IF EXISTS trigger_update_estadisticas_updated_at ON estadisticas_obra_social; CREATE TRIGGER trigger_update_estadisticas_updated_at BEFORE UPDATE ON estadisticas_obra_social
  FOR EACH ROW
