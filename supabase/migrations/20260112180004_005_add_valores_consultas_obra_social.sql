...
DROP TRIGGER IF EXISTS trigger_update_valores_consultas_updated_at ON valores_consultas_obra_social; CREATE TRIGGER trigger_update_valores_consultas_updated_at BEFORE UPDATE ON valores_consultas_obra_social
  FOR EACH ROW
