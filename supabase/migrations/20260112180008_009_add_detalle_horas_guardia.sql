...
DROP TRIGGER IF EXISTS trigger_update_detalle_horas_updated_at ON detalle_horas_guardia; CREATE TRIGGER trigger_update_detalle_horas_updated_at BEFORE UPDATE ON detalle_horas_guardia
  FOR EACH ROW
